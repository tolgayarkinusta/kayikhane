    ...
    while True:
        ...
        if zed.grab() == sl.ERROR_CODE.SUCCESS:
            ...
            if CURRENT_GOAL == GPS1:
                ...
                controller.set_servo(SOL_MOTOR, 1540+error)
                controller.set_servo(SAG_MOTOR, 1540+error)
            ...
            if manual_mode:
                ...
                if key == ord('w'):
                    ...
                    print("manual")
                    controller.set_servo(SOL_MOTOR, 1600)
                    controller.set_servo(SAG_MOTOR, 1600)
                elif key == ord('s'):
                    # Geri hareket: her iki motor geri
                    print("manual")
                    controller.set_servo(SOL_MOTOR, 1300)
                    controller.set_servo(SAG_MOTOR, 1300)
                elif key == ord('a'):
                    # Sola dönüş: sol motor yavaş, sağ motor hızlı
                    print("manual")
                    controller.set_servo(SOL_MOTOR, 1420)
                    controller.set_servo(SAG_MOTOR, 1580)
                elif key == ord('d'):
                    # Sağa dönüş: sol motor hızlı, sağ motor yavaş
                    print("manual")
                    controller.set_servo(SOL_MOTOR, 1580)
                    controller.set_servo(SAG_MOTOR, 1420)
                elif key == ord('l'):
